    ...
    <div className="container py-12">
      ...
      <Tabs defaultValue="vision">
        ...
        <TabsContent value="vision" className="space-y-6">
          ...
          <p className="mb-4">
            주님의교회는 소규모 신앙 공동체의 장점을 살려 한 분 한 분을 소중히 여기며, 
            개인별 맞춤 양육과 가족같은 돌봄이 가능한 건강한 교회를 지향합니다. 
          ...
          <div className="bg-slate-50 p-6 rounded-lg">
            ...
            <p>
              경주역 신도시에 새롭게 정착하신 여러분, 주님의교회는 아름다운 산길 10분 거리에 자리 잡은 소규모 신앙 공동체입니다. 
              한 분 한 분의 이름을 기억하고, 개인별 맞춤 양육이 가능한 가족같은 따뜻함으로 여러분을 기다리고 있습니다. 
